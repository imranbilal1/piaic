...
def function3():
    ...
    #example [35,70,105,..]
    x = np.arange(1,100*10+1).reshape((100,10))
    x = x[(x%5==0) & (x%7==0)]#wrtie your code here
    return x
    """
    Expected Output:
...
def function4():
    ...
    return x[:,[1,0,2]]#wrtie your code here
    """
    Expected Output:
          array([[1, 0, 2],
                [4, 3, 5],
...
def function5():
    ...
    z = np.zeros_like(np.arange(1,21).reshape(4,5))#wrtie your code here
...
def function6():
    ...
    arr = np.zeros_like(np.arange(1,11))
    arr[4]=10
    arr[7]=20
...
def function8():
    ...
    x = np.ones_like(np.arange(1,11).reshape(2,5))
    return x*6 #write your code here
...
def function9():
    ...
    a = np.arange(1,51)
    return a*2 # write your code here
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.hstack((arr[0],arr[0],arr[0],arr[1],arr[1],arr[1],arr[2],arr[2],arr[2],arr,arr,arr))
    return ans
